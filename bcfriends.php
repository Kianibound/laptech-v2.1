...
$query  = "SELECT * FROM bcfriends WHERE user='$view'";
...
$query  = "SELECT * FROM bcfriends WHERE friend='$view'";
$result = queryMysql($mysqli, $query);
$num    = mysqli_num_rows($result);
...
if (sizeof($mutual))
{
	...
	foreach($mutual as $friend)
		echo "<li><a href='bcmembers.php?view=$friend'>$friend</a>";
	echo "</ul>";
	$friends = TRUE;
}
...
echo "</ul><a href='bcmessages.php?view=$view'>View $name2 messages</a>";
?>
