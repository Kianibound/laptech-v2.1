...
for ($i = 0; $i < 12; ++$i)
{
    ...
    echo "<table class = tablefloatleft><tr><th>salesorder</th><th>item</th><th>quantity</th><th>productcode</th><th>customer</th><th>description</th><th>date requested</th><th>date expected to ship</th><th>date shipped</th></tr>
                ";
            for ($ki = 0; $ki < $num; ++$ki)
            {
    ...
    echo "<table class = margin_only border='4'>
                    <tr>
                    <th>Month</th>
                    <th>Year</th>
                    <th>Total Ordered</th>
...
echo "
<form method='post' action='bcontimesearch.php?'
...
(function() {
    ...
    { 
        ...
        var myotherchart = new Y.Chart({dataProvider:myDataValues, render:'#myotherchart'});
    });
})();
</script>
