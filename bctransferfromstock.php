...
$In_Stock = $into_stock = $OpNo = $Date_In = $Date_out = $Batchno = $Product_code = $Stock_ID = $Location = $Notes = $Stock = $From_Stock = $Date = $Product_code2 = $InitialOpNo = $Initialbatchno = "";
...
If ($In_Stock >= $From_Stock || $into_stock != 0)
{
