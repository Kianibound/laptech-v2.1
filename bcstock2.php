...
// $result2 = $mysqli->query("SELECT * FROM bcstock ORDER BY $Arrange");
 ...
 //echo $num2;
    for ($j = 0; $j < $num2; ++$j)
    {
        ...
        {
            //echo $j;
            echo '<tr><td><a href="bcstock.php?ID='.$row2[8].'&amp;Search='.$Search.'&amp;Arrange='.$Arrange.'"></a>'.$row2[8].'</td>
        <td><a href="bcstock.php?ID='.$row2[8].'&amp;Arrange='.$Arrange.'">'.$row2[7].'</a></td>
        <td><a href="bcstock.php?ID='.$row2[8].'&amp;Arrange='.$Arrange.'">'.$row2[6].'</a></td>
        <td><a href="bcstock.php?ID='.$row2[8].'&amp;Arrange='.$Arrange.'">'.$row2[3].'</a></td>
        <td><a href="bcstock.php?ID='.$row2[8].'&amp;Arrange='.$Arrange.'">'.$row2[0].'</a></td>
        <td><a href="bcstock.php?ID='.$row2[8].'&amp;Arrange='.$Arrange.'">'.$row2[2].'</a></td>
        <td><a href="bcstock.php?ID='.$row2[8].'&amp;Arrange='.$Arrange.'">'.$row2[1].'</a></td>
        <td><a href="bcstock.php?ID='.$row2[8].'&amp;Arrange='.$Arrange.'">'.$row2[4].'</a></td>
        <td><a href="bcstock.php?ID='.$row2[8].'&amp;Arrange='.$Arrange.'">'.$row2[5].'</a></td>
        </tr>';
            ...
            echo '</table>
                ...
                <div style="margin:80px"><form method="post" action="bccomfirm.php"><table class="floatleft">
                <th colspan="2" align="center">Stock Transfer to Batch</th><tr>
                <td>Product :</td><td> <select name="batchno" class="batchno">
                <option selected="selected">--Select Destination Batch--</option>'
                 ;
                                                       
                $inf_result = $mysqli->query("SELECT batchno, productdescription, productcode FROM bcbatchinfo WHERE (status = 1 OR status = 3)");
                ...
                <tr><td>Destination Operation:</td> <td><select name="OpNo" class="OpNo">
                ...
                echo'
                <tr><td>Quantity to Transfer</td><td><input type="text" maxlength="16"
                        name="From_Stock"></td></tr>
