...
<table class = floatleft border='4' cellpadding='2'
                        ...
                        <form method='post' action='bccompareop.php??'
...
$result1 = queryMysql($mysqli, "SELECT * FROM bcoperationsdone WHERE DATE(start) BETWEEN '$req_date' AND '$to_date' AND operation ='$Op1' ORDER BY $Arrange");
//$result = queryMysql($mysqli, "SELECT * FROM bcoperationsdone WHERE DATE(start) = '$req_date' ORDER BY '$Arrange'");
$num1 = mysqli_num_rows($result1);

$result2 = queryMysql($mysqli, "SELECT * FROM bcoperationsdone WHERE DATE(start) BETWEEN '$req_date' AND '$to_date' AND operation ='$Op2' ORDER BY $Arrange");
//$result = queryMysql($mysqli, "SELECT * FROM bcoperationsdone WHERE DATE(start) = '$req_date' ORDER BY '$Arrange'");
...
echo"   <table class = tablefloatleft border='4'cellpadding='2'
                    ...
                    <tr>
                    <th><a href='bcwcompareop.php?Arrange=staffnumber&work_done_date=".$req_date."&Op1=".$Op1."&Op2=".$Op2."'>Batch Number</th>
                    <th><a href='bcwcompareop.php?Arrange=staffnumber&work_done_date=".$req_date."&Op1=".$Op1."&Op2=".$Op2."'>Operation</th>
                    <th><a href='bcwcompareop.php?Arrange=staffnumber&work_done_date=".$req_date."&Op1=".$Op1."&Op2=".$Op2."'>OpName</th>
                    <th><a href='bcwcompareop.php?Arrange=staffnumber&work_done_date=".$req_date."&Op1=".$Op1."&Op2=".$Op2."'>Quantity Completed</th>
                    <th><a href='bcwcompareop.php?Arrange=staffnumber&work_done_date=".$req_date."&Op1=".$Op1."&Op2=".$Op2."'># Scrapped</th>
                    <th><a href='bcwcompareop.php?Arrange=staffnumber&work_done_date=".$req_date."&Op1=".$Op1."&Op2=".$Op2."'>start date/time</th>
                    <th><a href='bcwcompareop.php?Arrange=staffnumber&work_done_date=".$req_date."&Op1=".$Op1."&Op2=".$Op2."'>end date/time</th>
                    <th>Time Taken</th>
                    <th><a href='bcwcompareop.php?Arrange=staffnumber&work_done_date=".$req_date."&Op1=".$Op1."&Op2=".$Op2."'>Comments</th>
                    </tr>";
            $total = $scraptotal = 0;
