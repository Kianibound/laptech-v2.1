...
if (isset($_GET['view']))
{
	...
	echo "<a href='bcmessages.php?view=$view'>$name Messages</a><br />";
	die("<a href='bcfriends.php?view=$view'>$name Friends</a><br />");
}
...
$result = queryMysql($mysqli, "SELECT user FROM bcbatchinfo ORDER BY batchno");
$num = mysqli_num_rows($result);
echo "<h3>Open Batches</h3><ul>";
